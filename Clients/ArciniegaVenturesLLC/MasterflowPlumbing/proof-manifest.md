...
| Screenshot proof | Release-specific browser captures and hashes for the final homepage, service, city, blog, contact, reviews, commercial, admin, and sitemap presentation are attached under `proof/mflow-v.1.1.0/`; historical page captures remain under the earlier proof bundles. |
